...
export function SelectMenu({
  ...
  const menu = menuMounted && placement && (
    <div
      ...
      className={cn(
        "squircle-panel z-[100] overflow-y-auto border border-[#e3e8e5] bg-card p-1.5 shadow-[0_20px_60px_rgb(23_34_29/16%),0_3px_12px_rgb(23_34_29/6%)]",
        open
          ? placement.above
            ? "select-pop-above"
            : "select-pop"
