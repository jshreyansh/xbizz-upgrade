  ...
  return (
    <div className="rise-in flex w-full max-w-4xl gap-16 items-center">
      <div style={{ flex: 1, color: "var(--ink)" }}>
        <div style={{ fontSize: 11, letterSpacing: ".22em", textTransform: "uppercase", color: "var(--ink-4)", fontWeight: 700, marginBottom: 18 }}>How it works · 2 of 2</div>
      ...
      <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
        <div style={{ position: "relative", width: 320, height: 280 }}>
          ...
          <svg viewBox="0 0 320 280" style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }} fill="none">
            <path d="M160 140 C120 120 90 90 60 60" stroke="var(--tint-line)" strokeWidth="1.5" />
            <path d="M160 140 C200 120 230 90 262 60" stroke="var(--tint-line)" strokeWidth="1.5" />
            <path d="M160 140 C120 166 90 200 62 228" stroke="var(--tint-line)" strokeWidth="1.5" />
            <path d="M160 140 C200 166 230 200 258 230" stroke="var(--tint-line)" strokeWidth="1.5" />
          </svg>
          {/* Hub dossier icon */}
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 52, height: 52, borderRadius: 14, background: "var(--brand)", display: "grid", placeItems: "center", boxShadow: "0 10px 30px -10px rgba(253,72,22,.6)" }}>
          ...
          {outputs.map((o) => (
            ...
            >
              {o.isVideo && (
                <span style={{ width: 20, height: 20, borderRadius: "50%", background: "var(--brand)", display: "grid", placeItems: "center" }}>
                  <svg width={8} height={8} viewBox="0 0 24 24" fill="#fff"><path d="M6 4l14 8-14 8z" /></svg>
                </span>
              )}
              {o.label}
            </div>
