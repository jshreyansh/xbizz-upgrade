  ...
  return (
    <div className="page-enter space-y-6 max-w-[1140px] text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch pt-2">
        ...
        <div
          onClick={() => handleSelectMode("magic-chart")}
          className="group relative flex flex-col rounded-card border border-hair bg-card shadow-soft transition-all duration-300 hover:border-blue-500 hover:shadow-[0_16px_40px_rgba(59,130,246,0.14)] hover:-translate-y-1 cursor-pointer overflow-hidden text-left"
        >
          {/* Top Info & Features */}
          <div className="flex flex-col p-5 pb-4">
            <div className="flex items-center justify-between mb-3">
