...
export function ShareReviewModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-[560px] rounded-[24px] bg-white shadow-2xl border border-black/10 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 px-6 border-b border-[var(--line)] bg-[#fafbf9]">
          <div className="flex items-center gap-3">
            <div className="size-10 rounded-xl bg-[var(--tint)] text-[var(--brand)] border border-[var(--tint-line)] grid place-items-center">
          ...
          <button
            type="button"
            onClick={onClose}
            className="size-8 rounded-full hover:bg-black/5 grid place-items-center text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors cursor-pointer"
            aria-label="Close"
          >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-[11.5px] font-extrabold uppercase tracking-wider text-[var(--ink-muted)] flex items-center gap-1.5">
                <Lock className="size-3 text-[var(--brand)]" />
            ...
            <div className="flex items-center gap-2 p-1.5 pl-3 rounded-xl bg-[#f7f8f6] border border-black/10 focus-within:border-[var(--brand)] focus-within:ring-2 focus-within:ring-[var(--brand)]/10 transition-all">
              <input
                type="text"
                readOnly
                value={reviewUrl}
                className="flex-1 bg-transparent text-[12px] font-mono text-[var(--ink)] outline-none select-all truncate"
              />
              <Button
                size="sm"
                onClick={handleCopyLink}
                className={cn(
                  "h-8 px-3.5 rounded-lg text-[11.5px] font-bold transition-all cursor-pointer shadow-xs shrink-0 gap-1.5",
                  copied
          ...
          <div className="space-y-2.5">
            <div className="text-[11.5px] font-extrabold uppercase tracking-wider text-[var(--ink-muted)]">
            ...
            <div className="grid grid-cols-1 gap-2.5">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-3 rounded-2xl border border-black/10 bg-white hover:border-[#0078d4] hover:bg-[#f3f9fd] transition-all text-left shadow-2xs group cursor-pointer"
              >
                ...
                <div className="flex items-center gap-1 text-[11px] font-bold text-[#0078d4] opacity-80 group-hover:opacity-100 shrink-0 ml-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-3 rounded-2xl border border-black/10 bg-white hover:border-amber-600 hover:bg-[#fffcf5] transition-all text-left shadow-2xs group cursor-pointer"
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="size-9 rounded-xl bg-amber-500/10 text-amber-700 grid place-items-center shrink-0 border border-amber-500/20">
                    <ShieldCheck className="size-5 text-amber-600" />
                  </div>
                  <div>
                    <h4 className="text-[13px] font-bold text-[var(--ink)] flex items-center gap-1.5">
                      <span>Send to Veeva PromoMats</span>
                      <span className="rounded-md bg-amber-100/70 text-amber-800 text-[10px] font-bold px-1.5 py-0.2 border border-amber-300/60">
                        MLR Binder
                      </span>
                    </h4>
                    <p className="text-[11.5px] text-[var(--ink-muted)]">
                ...
                <div className="flex items-center gap-1 text-[11px] font-bold text-amber-700 opacity-80 group-hover:opacity-100 shrink-0 ml-2">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="text-[11.5px] font-extrabold uppercase tracking-wider text-[var(--ink-muted)]">
                Social &amp; Digital Channels
              </span>
              <span className="text-[10.5px] text-[var(--ink-muted)] font-medium">Direct publishing</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <button
                ...
                className="flex items-center justify-between p-2.5 px-3 rounded-xl border border-black/[0.08] bg-[#fafbf9] hover:bg-white hover:border-black/20 transition-all text-left group cursor-pointer"
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="text-[12.5px] font-bold text-[var(--ink)]">Instagram</span>
                </div>
                <span className="rounded-full bg-black/5 px-2 py-0.5 text-[9.5px] font-bold text-[var(--ink-muted)]">
                  Coming Soon
                </span>
              </button>
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="text-[12.5px] font-bold text-[var(--ink)]">LinkedIn</span>
                </div>
                <span className="rounded-full bg-black/5 px-2 py-0.5 text-[9.5px] font-bold text-[var(--ink-muted)]">
                  Coming Soon
                </span>
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="text-[12.5px] font-bold text-[var(--ink)]">YouTube</span>
                </div>
                <span className="rounded-full bg-black/5 px-2 py-0.5 text-[9.5px] font-bold text-[var(--ink-muted)]">
                  Coming Soon
                </span>
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="text-[12.5px] font-bold text-[var(--ink)]">Twitter / X</span>
                </div>
                <span className="rounded-full bg-black/5 px-2 py-0.5 text-[9.5px] font-bold text-[var(--ink-muted)]">
                  Coming Soon
                </span>
        ...
        {/* Footer */}
        <div className="p-4 px-6 border-t border-[var(--line)] bg-[#fafbf9] flex items-center justify-between">
